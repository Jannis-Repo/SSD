...
$SQLstring = "SELECT * FROM CLIENT_TYPE";
						...
						?>
							<div class="ibox float-e-margins">
								...
								<div class="ibox-content">
									...
									<input type="hidden" name="method" value="addClient">
										...
										<div class="form-group"><label class="col-sm-2 control-label">Type</label>
											<div class="col-sm-10">
												<select class="form-control" name="type">
													...
													?>
													<option value="<?php echo $row['ClientTypeID']; ?>"><?php echo ucfirst($row['ClientTypeName']); ?></option>
													<?php } ?>
												</select>
											</div>
										</div>
