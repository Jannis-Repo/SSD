...
$SQLstring = "SELECT * FROM INCIDENT_TYPE";
								...
								<div class="ibox-content">
									<form method="POST" class="form-horizontal" action="class/formProcessing.php">
										...
										<?php
											...
											if($_SESSION['auth'] != 0)
											{
												echo "<div class=\"form-group\"><label class=\"col-sm-2 control-label\">User ID</label>
														<div class=\"col-sm-10\"><input type=\"text\" class=\"form-control\" name=\"userID\" required>
														</div>
													</div>
											...
											{
												echo "<input type=\"hidden\" name=\"userID\" value=\"" .  $_SESSION['employeeID'] . "\">";
											}
										?>

										<input type="hidden" name="method" value="addIncident">
										<div class="form-group"><label class="col-sm-2 control-label">Description</label>
											<div class="col-sm-10"><input type="text" class="form-control" name="description" required> <span class="help-block m-b-none">Submit a detailed description of the incident here.</span>
											</div>
										</div>
										<div class="hr-line-dashed"></div>
											...
											<div class="col-sm-10">
												<select class="form-control" name="type">
													<?php while($row = mysqli_fetch_assoc($query)){ ?>
														<option value="<?= $row['IncidentTypeID'] ?>"><?= $row['IncidentTypeName'] ?></option>
													<?php } ?>
												</select>
											</div>
										</div>
